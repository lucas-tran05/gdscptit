        ...
        >
          <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-12 px-2 md:px-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed text-justify">
                Tháng 9/2022, GDSC-PTIT chính thức ra đời, là một chapter của
                GDSC tại Học viện Công nghệ Bưu chính Viễn thông. Đây là môi
                trường bổ ích để các thành viên có thể học tập và phát triển bản
                thân từ nguồn tài nguyên của Google, cùng nhau thực hiện sứ mệnh
                đem đến những giải pháp mang lại thay đổi tích cực cho địa
                phương và cộng đồng.
              </p>
            </div>
          </div>

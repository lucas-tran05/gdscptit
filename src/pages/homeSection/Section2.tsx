    ...
    return (
        <section className="relative flex items-center justify-center px-4 py-12 overflow-hidden">
            <div className="max-w-5xl mx-auto text-center relative z-10">
                ...
                <motion.div
                    className="border-2 border-gray-800 p-6 rounded-4xl bg-white shadow-lg mb-12"
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="flex flex-col lg:flex-row items-center gap-8 px-8">
                        <div className="flex-1">
                            <h2 className="font-bold text-2xl mb-2">Về Google Developer Groups</h2>
                        ...
                        <div className="flex-1">
                            <h2 className="font-bold text-2xl mb-2">Về GDG on Campus PTIT</h2>
                            <p className="text-gray-600 leading-relaxed">

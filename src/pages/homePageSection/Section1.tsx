...
import imgAlt1 from "@/assets/home/section3/img-3-s3-min.png"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-42 left-20 w-20 h-20 bg-yellow-200 rounded-full opacity-20"></div>
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                 w-96 h-96 bg-gradient-to-br from-blue-50 to-purple-100 rounded-full opacity-30"
        />
      </div>
